...
class Lang_TRX_Pluto(gr.top_block):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        plutoip = "ip:" + os.environ.get("PLUTO_IP", "pluto.local")
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
            interpolation=11, decimation=1, taps=[], fractional_bw=0
        )
        ...
        self.connect(
            (self.iio_pluto_source_0, 0), (self.freq_xlating_fir_filter_xxx_0, 0)
        )
